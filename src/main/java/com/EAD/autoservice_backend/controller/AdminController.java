...
@PreAuthorize("hasRole('ADMIN')") // <-- Best practice: Secure the whole class
public class AdminController {
    ...
    // Note: We will need a new DTO for updating a user
    // @PutMapping("/users/{id}")
    // public ResponseEntity<UserCreateResponse> updateUser(...) { ... }
